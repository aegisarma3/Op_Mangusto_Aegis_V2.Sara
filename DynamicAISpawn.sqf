...
_min_groups = 4;		// The mimimum number of groups that will be created
_max_groups = 4;		// The maximum number of groups that will be created. This number CANNOT exceed 8

_min_group_size = 6;	// The minimum number of people a group can contain
...
_max_distance = 120;	// This is the maximum spawn distance for a group from the trigger point

_max_enemy_distance = 20;	// This is the maximum distance a group can be from the player as the group follows the player around
...
_man_type=["CAF_AG_EEUR_R_AA","CAF_AG_EEUR_R_SVD","CAF_AG_EEUR_R_RPG","CAF_AG_EEUR_R_RPK74","CAF_AG_EEUR_R_GL","CAF_AG_EEUR_R_PKM","CAF_AG_EEUR_R_AK74","CAF_AG_EEUR_R_AK47"];
...
_man_odds_group0=[100,95,85,75,65,55,40,30];
_man_odds_group1=[100,95,85,75,65,55,40,30];
_man_odds_group2=[100,95,85,75,65,55,40,30];
_man_odds_group3=[100,95,85,75,65,55,40,30];
_man_odds_group4=[100,95,85,75,65,55,40,30];
_man_odds_group5=[100,95,85,75,65,55,40,30];
_man_odds_group6=[100,90,80,70,50,40,20,5];
_man_odds_group7=[100,90,80,70,50,40,20,5];
...
_group_spawn_delay_min=[30,45,30,60,60,30]; 
_group_spawn_delay_max=[40,60,60,80,65,40]; 
_sleep_delay = 15;						// This MUST be at least two times less than any of the _group_spawn_delay numbers
...
_group_skill=[0.8, 0.8, 0.8 ,0.8, 0.8, 0.8, 0.9, 0.9];
